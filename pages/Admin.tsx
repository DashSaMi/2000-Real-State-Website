                ...
                <tbody className="divide-y divide-gray-700">
                  {properties.map(p => (
                    <tr key={p.id} className="text-gray-300 hover:bg-white/5 transition-colors">
                      ...
                      <td className="p-4"><span className="px-2 py-1 rounded bg-gray-700 text-xs">{p.type}</span></td>
                      <td className="p-4 text-sm">{p.dateAdded}</td>
                      <td className="p-4 flex gap-2">
                        <button className="p-2 bg-blue-500/20 text-blue-400 rounded hover:bg-blue-500 hover:text-white"><Edit size={16}/></button>
                        <button className="p-2 bg-red-500/20 text-red-400 rounded hover:bg-red-500 hover:text-white"><Trash2 size={16}/></button>
                      </td>
                    </tr>
                  ))}
                </tbody>
                ...
                <tbody className="divide-y divide-gray-700">
                  {users.map(u => (
                    <tr key={u.id} className="text-gray-300 hover:bg-white/5 transition-colors">
                      ...
                      <td className="p-4"><span className={`px-2 py-1 rounded text-xs ${u.role === 'admin' ? 'bg-accent/20 text-accent' : 'bg-gray-700'}`}>{u.role}</span></td>
                      <td className="p-4 flex gap-2">
                        <button className="p-2 bg-red-500/20 text-red-400 rounded hover:bg-red-500 hover:text-white"><Trash2 size={16}/></button>
                      </td>
                    </tr>
