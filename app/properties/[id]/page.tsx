...
import { MapPin, Bed, Bath, Move, Check, Phone, Mail, ArrowLeft } from 'lucide-react';
...
export default function PropertyDetailPage() {
  ...
  if (!property) {
    return <div className="text-white text-center pt-32">Property not found</div>;
  }
            ...
            <div className="flex flex-col md:flex-row justify-between items-end">
              <div>
                ...
                <p className="text-xl text-gray-300 flex items-center gap-2">
                  <MapPin className="text-accent" /> {property.location}
                </p>
              </div>
            ...
            <div className="bg-secondary p-8 rounded-lg border border-gray-700 sticky top-24">
              ...
              <form className="space-y-4">
                <input
                  ...
                  className="w-full bg-primary border border-gray-600 rounded p-3 text-white focus:border-accent outline-none"
                />
                <input
                  type="email"
