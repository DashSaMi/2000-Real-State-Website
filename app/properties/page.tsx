        ...
        {filteredProperties.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredProperties.map((property) => (
              <div
                key={property.id}
                className="bg-secondary rounded-lg overflow-hidden border border-gray-800 hover:border-gray-600 transition-all duration-300 group flex flex-col"
              >
                ...
                <div className="p-6 flex-grow flex flex-col">
                  ...
                  <Link
                    ...
                    className="mt-auto w-full bg-primary border border-gray-600 text-center py-3 text-white rounded hover:bg-accent hover:text-primary hover:border-accent transition-all font-semibold uppercase text-sm"
                  >
                    View Property
                  </Link>
                </div>
