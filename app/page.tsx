    ...
    <Section className="py-20 bg-secondary border-t border-gray-800">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-serif text-white mb-8">
          <span className="text-accent">AI</span> Smart Match
        </h2>
        <p className="text-gray-400 mb-12 max-w-2xl mx-auto">
          Let our advanced algorithm scan thousands of properties to find your perfect match in seconds.
        </p>
              ...
              {step === 1 && (
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <button
                      onClick={() => setStep(2)}
                      className="p-4 border border-gray-600 rounded hover:border-accent hover:bg-accent/10 text-white transition-all"
                    >
                      Buy a Home
                    </button>
                    <button
              ...
              {step === 2 && (
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}>
                  ...
                  <input
                    ...
                    className="w-full bg-secondary p-4 rounded text-white border border-gray-600 focus:border-accent mb-4 outline-none"
                  />
                  <div className="flex justify-between">
                    <button onClick={() => setStep(1)} className="text-gray-400 hover:text-white">
                      Back
                    </button>
                    <button onClick={() => setStep(3)} className="bg-accent text-primary px-6 py-2 rounded font-bold">
                      Next
                    </button>
                  </div>
                </motion.div>
              ...
              {step === 3 && (
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}>
                  ...
                  <button
                    ...
                    className="w-full bg-accent text-primary py-4 rounded font-bold hover:bg-white transition-all"
                  >
                    Find My Home
                  </button>
                </motion.div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <Link
                    ...
                    className="mt-4 inline-block bg-white text-primary px-4 py-2 rounded text-sm font-bold"
                  >
                    View Details
                  </Link>
                </div>
      ...
      <div className="relative w-full h-[600px] bg-secondary group">
        ...
        <AnimatePresence>
          {activePin && (
            ...
            >
              <button onClick={() => setActivePin(null)} className="absolute top-4 right-4 text-gray-400 hover:text-white">
                <X />
              </button>
      ...
      <div className="flex flex-col md:flex-row gap-12 items-center">
        <div className="flex-1">
          ...
          <p className="text-gray-400 mb-6 text-lg">
            Visualize property values across top neighborhoods. Identify investment opportunities with our real-time color-coded analytics.
          </p>
          <div className="flex gap-4 text-sm mb-8">
            <div className="flex items-center text-gray-300">
              <div className="w-4 h-4 bg-emerald-500 rounded mr-2"></div> Value
            </div>
            <div className="flex items-center text-gray-300">
              <div className="w-4 h-4 bg-yellow-500 rounded mr-2"></div> Premium
            </div>
            <div className="flex items-center text-gray-300">
              <div className="w-4 h-4 bg-red-500 rounded mr-2"></div> Ultra Luxury
            </div>
          </div>
          <button className="border border-accent text-accent px-6 py-3 rounded hover:bg-accent hover:text-primary transition-colors">
            Analyze Market
          </button>
        </div>
          ...
          {[...Array(32)].map((_, i) => (
            <motion.div
              ...
              className={`rounded-sm ${
                i % 5 === 0 ? 'bg-red-500/60' : i % 3 === 0 ? 'bg-yellow-500/60' : 'bg-emerald-500/60'
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 bg-secondary p-8 rounded-xl border border-gray-700 shadow-2xl">
          <div className="space-y-6">
            <div>
              <label className="text-gray-400 block mb-2">
                Property Price: <span className="text-white font-bold">${price.toLocaleString()}</span>
              </label>
              <input
                type="range"
                min="100000"
            ...
            <div>
              <label className="text-gray-400 block mb-2">
                Down Payment: <span className="text-white font-bold">${downPayment.toLocaleString()}</span>
              </label>
              <input
                type="range"
                min="0"
            ...
            <div>
              <label className="text-gray-400 block mb-2">
                Interest Rate: <span className="text-white font-bold">{rate}%</span>
              </label>
              <input
                type="range"
                min="1"
          ...
          <div className="flex flex-col justify-center items-center bg-primary rounded-xl p-8 border border-gray-800">
            ...
            <button className="mt-8 bg-white text-primary px-8 py-3 rounded font-bold hover:bg-gray-200 transition-colors">
              Get Pre-Approved
            </button>
          </div>
        </div>
    ...
    <Section className="py-20 bg-secondary">
      <div className="container mx-auto px-6">
        ...
        <p className="text-center text-gray-400 mt-6 italic">
          Market trends based on average price per sqft over the last 6 months.
        </p>
      </div>
    </Section>
  );
  ...
  <Section className="py-20 bg-primary">
    <div className="container mx-auto px-6">
      <div className="flex justify-between items-end mb-12">
        ...
        <button className="text-accent flex items-center gap-2 hover:text-white transition-colors">
          See All Areas <ArrowRight size={18} />
        </button>
      </div>
    ...
    <div className="container mx-auto px-6 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-gray-700 rounded-xl overflow-hidden bg-primary">
        {[1, 2, 3].map((item, idx) => (
          <div
            key={idx}
            className={`p-8 ${idx !== 2 ? 'border-r border-gray-700' : ''} hover:bg-gray-900 transition-colors`}
          >
            ...
            <ul className="text-sm text-gray-400 space-y-2">
              <li className="flex justify-between border-b border-gray-800 pb-1">
                <span>Price</span> <span className="text-white">$2.5M</span>
              </li>
              <li className="flex justify-between border-b border-gray-800 pb-1">
                <span>Size</span> <span className="text-white">4500 sqft</span>
              </li>
              <li className="flex justify-between border-b border-gray-800 pb-1">
                <span>Beds</span> <span className="text-white">5</span>
              </li>
              <li className="flex justify-between border-b border-gray-800 pb-1">
                <span>Year</span> <span className="text-white">2022</span>
              </li>
            </ul>
            <button className="mt-6 w-full border border-gray-600 text-white py-2 rounded hover:border-accent hover:text-accent">
              Select
            </button>
          </div>
        ))}
      ...
      <div className="flex flex-wrap justify-center gap-12 md:gap-24 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
        {partners.map((p, i) => (
          <div key={i} className="flex items-center gap-2 text-2xl font-serif font-bold text-white">
            <span className="w-10 h-10 bg-gray-800 flex items-center justify-center rounded border border-gray-700 text-accent text-sm">
              {p.logo}
            </span>
          ...
          <details key={i} className="bg-primary rounded-lg border border-gray-700 group">
            <summary className="flex justify-between items-center p-6 cursor-pointer list-none text-white font-semibold">
              <span className="flex items-center gap-3">
                <HelpCircle size={18} className="text-accent" /> {faq.q}
              </span>
              <ChevronDown className="group-open:rotate-180 transition-transform text-gray-500" />
            </summary>
            <div className="px-6 pb-6 text-gray-400 pl-12">{faq.a}</div>
          </details>
        ))}
      </div>
    </div>
...
const ChatWidget = () => {
  ...
  const handleSend = (e: any) => {
    ...
    setTimeout(() => {
      setMsgs((prev) => [
        ...prev,
        { from: 'bot', text: 'Thank you. An agent will review your request and contact you shortly.' }
      ]);
    }, 1000);
  };
          ...
          >
                ...
                <div key={i} className={`flex ${m.from === 'user' ? 'justify-end' : 'justify-start'}`}>
                  <div
                    className={`max-w-[80%] p-3 rounded-lg text-sm ${
                      m.from === 'user' ? 'bg-accent text-primary' : 'bg-gray-700 text-white'
                    }`}
                  >
                    {m.text}
                  </div>
            ...
            <form onSubmit={handleSend} className="p-3 bg-primary border-t border-gray-700 flex gap-2">
              <input
                ...
                className="flex-1 bg-secondary text-white px-3 py-2 rounded border border-gray-600 focus:border-accent outline-none text-sm"
              />
              <button type="submit" className="bg-accent text-primary p-2 rounded hover:bg-white">
                <Send size={18} />
              </button>
            </form>
          </motion.div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <input
                ...
                className="p-3 bg-secondary/80 text-white rounded border border-gray-600 focus:border-accent outline-none"
              />
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {categories.map((cat, idx) => (
              <div
                key={idx}
                className="bg-primary p-8 rounded-lg border border-gray-800 hover:border-accent transition-all duration-300 group cursor-pointer text-center"
              >
      ...
      <Section className="py-24 bg-primary">
        <div className="container mx-auto px-6">
          <div className="flex justify-between items-end mb-12">
            ...
            <Link
              href="/properties"
              className="text-accent hover:text-white flex items-center gap-2 transition-colors"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredProperties.map((property) => (
              <div
                key={property.id}
                className="bg-secondary rounded-lg overflow-hidden border border-gray-800 hover:shadow-2xl hover:shadow-accent/10 transition-all duration-300 group"
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-400 flex items-center mb-6 text-sm">
                    <Search size={14} className="mr-2" /> {property.location}
                  </p>
                  ...
                  <Link
                    ...
                    className="block mt-6 text-center w-full border border-gray-600 py-2 text-white hover:bg-accent hover:text-primary hover:border-accent transition-colors rounded-sm text-sm uppercase font-semibold"
                  >
                    View Details
                  </Link>
                </div>
            ...
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-primary p-8 rounded border border-gray-800 relative hover:border-accent transition-colors">
                ...
                <p className="text-gray-400 italic mb-6">
                  "Finding our dream home was effortless with CroState. Their attention to detail and premium service is unmatched in the industry."
                </p>
                <div className="flex items-center gap-4">
                  <img
                    src={`https://picsum.photos/seed/user${i}/100/100`}
                    alt="User"
                    className="w-12 h-12 rounded-full border border-accent"
                  />
                  <div>
      ...
      <Section className="py-24 bg-accent relative">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-primary/80 text-xl mb-8 max-w-2xl mx-auto">
            Contact our specialized agents today to schedule a viewing or discuss your investment.
          </p>
          <div className="flex justify-center gap-4">
            <Link
              href="/contact"
              className="bg-primary text-white px-8 py-4 rounded font-bold hover:bg-white hover:text-primary transition-all shadow-xl"
            >
              Book Consultation
            </Link>
